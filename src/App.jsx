...
export default function App() {
  ...
  /* Challenge
	...
	Uygulamanın çalışması için yukarıdaki handleClick fonksiyonunun tamamlanması gerekir. Fonksiyon, kullanıcı butonlardan birine tıkladığında 
  çağrıldığında üç şey yapmalıdır (satır 77 ila 85): 
